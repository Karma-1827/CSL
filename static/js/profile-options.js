(() => {
  ...
  const LANGUAGE_CODES = "zh yue en ja ko vi id th tl ms hi fr de es it pt ru ar af am as az be bg bn bo bs ca cs cy da el et eu fa fi fo ga gl gu he hr hu hy is ka kk km kn ku ky lo lt lv mk ml mn mr my ne nl no or pa pl ro si sk sl sq sr sv sw ta te tr uk ur uz zu".split(" ");
