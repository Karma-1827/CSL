...
urlpatterns = [
    ...
    path("class-documents/save/", views.save_class_document, name="save_class_document"),
    path("class-documents/<int:pk>/save/", views.save_class_document, name="update_class_document"),
    path("class-documents/<int:pk>/delete/", views.delete_class_document, name="delete_class_document"),
